...
class AdminModel extends BaseModel
{
    ...
    protected $_validate = array(
        ...
        array('password','require','密码必填！',self::EXISTS_VALIDATE,'regex',self::MODEL_INSERT), //默认情况下用正则进行验证
        array('encrypt','require','encrypt必填！',self::EXISTS_VALIDATE,'regex',self::MODEL_INSERT), //默认情况下用正则进行验证
        array('roleid',0,'请选择所属角色',self::MUST_VALIDATE,'notequal'), // 在新增和修改时验证角色id不等于0时，通过验证
