...
//    $('textarea.autogrow').autogrow();
    ...
    $('ul.gallery li').hover(function () {
        ...
        '<p><a href="#" class="gallery-ok btn"><i class="glyphicon glyphicon-ok" title="审核通过"></i></a> <a href="#" class="gallery-delete btn del"><i class="glyphicon glyphicon-remove" title="审核不通过"></i></a></p>' +
        '</div>');
    ...
    //gallery edit
    $('.thumbnails').on('click', '.gallery-ok', function (e) {
        e.preventDefault();
        //get image id
